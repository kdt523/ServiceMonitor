...
class Settings(BaseSettings):
    # Database
    database_url: str = "postgresql+asyncpg://servicemonitor:servicemonitor@localhost:5432/servicemonitor"
    ...
    smtp_user: str = ""
    smtp_password: str = ""
    smtp_from_name: str = "ServiceMonitor"
    smtp_from_email: str = ""

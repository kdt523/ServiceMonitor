...
async def check_http(url: str, keyword: str | None = None, headers: dict | None = None) -> dict:
    ...
    try:
        default_headers = {
            "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36 (ServiceMonitor/2.0; +https://github.com/user/servicemonitor; user@example.com)"
        }

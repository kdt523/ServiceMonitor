"""
AI Chat service — ServiceMonitor Copilot powered by Google Gemini (gemini-2.5-flash).
...
# ---------------------------------------------------------------------------
# System prompt — seeds every conversation with ServiceMonitor domain knowledge
# ---------------------------------------------------------------------------
SYSTEM_PROMPT = """You are ServiceMonitor Assistant — an expert AI copilot embedded inside ServiceMonitor, \
a self-hosted, production-grade uptime monitoring platform.

━━━ WHAT SERVICEMONITOR MONITORS ━━━
ServiceMonitor monitors hosts across four service types:
